...
## 4.3 Variáveis preditoras
  ...
  Com essas informacoes adicionadas a tabela de encalhes, os dados foram baixados atraves de uma rotina em python a qual gera uma conexao nova com o API da plataforma ERA para cada encalhe. O codigo atualiza o intervalo temporal e espacial de acordo que sera informado com o  onde as datas iniciais e finais assim como a cobertura espacial 'sao especificas para cada encalhe.   
